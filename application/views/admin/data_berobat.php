                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <!-- <a href="#" class="btn btn-danger glyphicon glyphicon-print">Cetak</a> -->
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($items as $i) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $i['alamat'] ?></td>
                                                    <td><?= $i['status'] ?></td>
                                                    <td><a href="<?= base_url('medis/hapus_antrian') ?>?id=<?= $i['id'] ?>"><i class="glyphicon glyphicon-trash btn btn-primary"></i> </a> </td>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pasien as $i) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $i['umur'] ?></td>
                                                    <td><?= $i['alamat'] ?></td>
                                                    <td><a href="<?= base_url('medis/insert_antrian') ?>?no_medis=<?= $i['no_medis'] ?>" class="btn btn-success">Masuk Antrian</a></td>
                                                </tr>
                                            <?php $no++;
                                            } ?>
                                        </tbody>
